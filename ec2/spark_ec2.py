...
def launch_cluster(conn, opts, cluster_name):
    ...
    if main_group.rules == []:  # Group was just now created
        ...
        main_group.authorize('tcp', 6379, 6379, authorized_address)
        main_group.authorize('tcp', 2181, 2181, authorized_address)
        main_group.authorize('tcp', 9092, 9092, authorized_address)
